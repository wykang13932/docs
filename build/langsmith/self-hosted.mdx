...
<Tip>
To set up a [LangGraph Server](/langsmith/langgraph-server), refer to the [how-to guide](/langsmith/deploy-standalone-server) in the application deployment section.
</Tip>
