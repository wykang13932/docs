...
<Tip>
For production use, deploy LangGraph Server with a persistent storage backend. For more information, refer to the LangSmith [hosting options](/langsmith/platform-setup).
</Tip>
...
For more details, refer to the [hosting comparison](/langsmith/platform-setup).
